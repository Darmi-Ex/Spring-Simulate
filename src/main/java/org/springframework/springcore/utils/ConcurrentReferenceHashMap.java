package org.springframework.springcore.utils;
...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    private V put(K key, final V value, final boolean overwriteExisting) {
        return this.doTask(key, new ConcurrentReferenceHashMap<K, V>.Task<V>(new ConcurrentReferenceHashMap.TaskOption[]{ConcurrentReferenceHashMap.TaskOption.RESTRUCTURE_BEFORE, ConcurrentReferenceHashMap.TaskOption.RESIZE}) {
            @Nullable
            protected V execute(@Nullable ConcurrentReferenceHashMap.Reference<K, V> reference, @Nullable ConcurrentReferenceHashMap.Entry<K, V> entry, @Nullable ConcurrentReferenceHashMap<K, V>.Entries entries) {
                if (entry != null) {
    ...
    public V remove(Object key) {
        return this.doTask(key, new ConcurrentReferenceHashMap<K, V>.Task<V>(new ConcurrentReferenceHashMap.TaskOption[]{ConcurrentReferenceHashMap.TaskOption.RESTRUCTURE_AFTER, ConcurrentReferenceHashMap.TaskOption.SKIP_IF_EMPTY}) {
            @Nullable
            protected V execute(@Nullable ConcurrentReferenceHashMap.Reference<K, V> reference, @Nullable ConcurrentReferenceHashMap.Entry<K, V> entry) {
                if (entry != null) {
                    if (reference != null) {
                        reference.release();
                    }
    ...
    public boolean remove(Object key, final Object value) {
        Boolean result = (Boolean)this.doTask(key, new ConcurrentReferenceHashMap<K, V>.Task<Boolean>(new ConcurrentReferenceHashMap.TaskOption[]{ConcurrentReferenceHashMap.TaskOption.RESTRUCTURE_AFTER, ConcurrentReferenceHashMap.TaskOption.SKIP_IF_EMPTY}) {
            protected Boolean execute(@Nullable ConcurrentReferenceHashMap.Reference<K, V> reference, @Nullable ConcurrentReferenceHashMap.Entry<K, V> entry) {
    ...
    private abstract class Task<T> {
        ...
        @Nullable
        protected T execute(@Nullable ConcurrentReferenceHashMap.Reference<K, V> reference, @Nullable ConcurrentReferenceHashMap.Entry<K, V> entry, @Nullable ConcurrentReferenceHashMap<K, V>.Entries entries) {
            return this.execute(reference, entry);
        }

        @Nullable
        protected T execute(@Nullable ConcurrentReferenceHashMap.Reference<K, V> reference, @Nullable ConcurrentReferenceHashMap.Entry<K, V> entry) {
            return null;
        }
    }
    ...
    protected final class Segment extends ReentrantLock {
        ...
        @Nullable
        private ConcurrentReferenceHashMap.Reference<K, V> findInChain(ConcurrentReferenceHashMap.Reference<K, V> reference, @Nullable Object key, int hash) {
            for(ConcurrentReferenceHashMap.Reference currRef = reference; currRef != null; currRef = currRef.getNext()) {
