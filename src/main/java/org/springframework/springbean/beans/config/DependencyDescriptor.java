package org.springframework.springbean.beans.config;
...
import org.springframework.springbean.beans.factory.InjectionPoint;
import org.springframework.springbean.beans.factory.NoUniqueBeanDefinitionException;
import org.springframework.springcore.core.GenericTypeResolver;
import org.springframework.springcore.core.KotlinDetector;
import org.springframework.springcore.core.MethodParameter;
import org.springframework.springcore.core.ParameterNameDiscoverer;
...
public class DependencyDescriptor extends InjectionPoint implements Serializable {
  ...
  public boolean isRequired() {
    if (!this.required) {
      ...
      return this.field.getType() != Optional.class && !this.hasNullableAnnotation() && (!KotlinDetector.isKotlinType(this.field.getDeclaringClass()) || !DependencyDescriptor.KotlinDelegate.isNullable(this.field));
    }
  }
